...
public class PlayerController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        smoothedVelocity.x += (targetVelocity.x - smoothedVelocity.x) / movementSmoothness;
        smoothedVelocity.y += (targetVelocity.y - smoothedVelocity.y) / movementSmoothness;
    ...
    private void Update()
    {
        ...
        targetVelocity = inputs * playerSpeed;
    }
